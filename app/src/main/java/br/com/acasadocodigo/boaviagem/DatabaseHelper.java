...
/**
 * Created by SIDNEY on 01/03/2016.
 */
public class DatabaseHelper extends  SQLiteOpenHelper{

    private static String BANCO_DADOS = "BoaViagem";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql = "DROP TABLE IF EXISTS Viagem" ;
        db.execSQL(sql);
        String sql2 = "DROP TABLE IF EXISTS gasto" ;
        db.execSQL(sql2);
        onCreate(db);
